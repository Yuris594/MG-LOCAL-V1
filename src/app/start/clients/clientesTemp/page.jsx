...
const ClientesTemp = () => {
  ...
  useEffect(() => {
    if (Array.isArray(cartera)) {
      const sumaSaldo60 = cartera.reduce(
        (total, item) => total + item.SMayorA60,
        0
      );
