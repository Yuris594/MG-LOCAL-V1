            ...
            <Box sx={{ display: "flex", flexDirection: "column", zoom: 2, width: "auto", }}>
              <ButtonGroup variant="text" aria-label="text button group" sx={{ height: 60 }}>
                <Button sx={{ flexDirection: "row" }}>
                  <Typography variant="outline" sx={{ display: "flex", paddingRight: 2, color: "black", fontSize: "1vw", }} gutterBottom> Cambio: $ </Typography>
                  <Typography sx={{ fontSize: "1vw" }} gutterBottom> {cambio.toLocaleString("es")} </Typography>
                </Button>

                <Button sx={{ flexDirection: "row" }}>
                  <Typography variant="outline" sx={{ display: "flex", paddingRight: 2, color: "black", fontSize: "1vw", }} gutterBottom> Restante: $ </Typography>
                  <Typography sx={{ fontSize: "1vw" }} gutterBottom> {restante.toLocaleString("es")} </Typography>
                </Button>

                <Button sx={{ flexDirection: "row" }}>
                  <Typography variant="outline" sx={{ display: "flex", paddingRight: 2, color: "black", fontSize: "1vw", }} gutterBottom > Total: $ </Typography>
                  <Typography sx={{ fontSize: "1vw" }} gutterBottom> {caja.total} </Typography>
                </Button>
              </ButtonGroup>
            </Box>
              ...
              <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", alignContent: "center", width: "100%", height: "100%", zoom: 1.5, }} >
                ...
                <ButtonGroup orientation="vertical" aria-label="vertical contained button group" variant="text" sx={{ margin: "2px", width: "50%", height: "100%" }}>
                  <Button variant="outlined" sx={{ height: "100px" }} value={2} onClick={handleClick}>
                    2
                  </Button>
