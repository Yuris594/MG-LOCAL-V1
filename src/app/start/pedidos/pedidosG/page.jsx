      ...
      <Box>  <Banner /> </Box>
        <div className='container'>
          <Box sx={{ padding: '20px' }}>
                                ...
                                <Grid item xs={12} sm={6.3} md={6.3} lg={6.3}>
                                    <FormControl sx={{ margin: 0.5, display: "flex" }}>
                                        <InputLabel htmlFor="component-disabled">Nota Factura (Doc2)</InputLabel>
                                            <OutlinedInput label="Nota Factura (Doc2)" id="OBSERVACIONES"  name='OBSERVACIONES'  autoComplete="OBSERVACIONES"  value={form.OBSERVACIONES}  onChange={changed} autoFocus />
                                    </FormControl>
                                </Grid>
            ...
            <Modal open={open} onClose={guardar} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description" BackdropProps={{ style: {  pointerEvents: 'none',   }, }}>
                <Box sx={style}>
